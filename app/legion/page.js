...
const students = [
    ...
    { name: 'Harini G', role: 'Joint Secretary', year: 'B. Tech IT / IV Year', sym: '△', color: 'var(--secondary)' },
    { name: 'Avanthika A', role: 'Joint Secretary', year: 'B. Tech IT / IV Year', sym: '□', color: 'var(--accent)' },
    { name: 'Izhaan Waseem. M', role: 'Treasurer', year: 'B. Tech IT / IV Year', sym: '○', color: '#a855f7' },
    { name: 'Rishika Rai', role: 'Executive Member', year: 'B. Tech IT / IV Year', sym: '△', color: '#22c55e' },
    { name: 'Swetha K', role: 'Executive Member', year: 'B. Tech IT / IV Year', sym: '□', color: '#f97316' },
    { name: 'Siddique S A', role: 'Executive Member', year: 'B. Tech IT / IV Year', sym: '○', color: '#06b6d4' },
    { name: 'Jerlin Sibiyal', role: 'Executive Member', year: 'B. Tech IT / IV Year', sym: '△', color: 'var(--secondary)' },
    { name: 'Niyajudeen N', role: 'Executive Member', year: 'B. Tech IT / IV Year', sym: '□', color: 'var(--accent)' },
    { name: 'Shrinivas J R', role: 'Executive Member', year: 'B. Tech IT / IV Year', sym: '○', color: 'var(--primary)' },
    { name: 'Noorul Afreen M.T', role: 'Executive Member', year: 'B. Tech IT / IV Year', sym: '△', color: '#22c55e' },
    { name: 'Md Saifuddeen S', role: 'Executive Member', year: 'B. Tech IT / IV Year', sym: '□', color: '#f97316' },
    { name: 'Md Fazhululla S', role: 'Executive Member', year: 'B. Tech IT / IV Year', sym: '○', color: '#06b6d4' },
    { name: 'Abirama Varshini V', role: 'Executive Committee Member', year: 'B. Tech IT / IV Year', sym: '△', color: 'var(--secondary)' },
    { name: 'Abirami M', role: 'Executive Committee Member', year: 'B. Tech IT / IV Year', sym: '□', color: 'var(--accent)' },
    { name: 'Afraa N', role: 'Executive Committee Member', year: 'M. Tech IT / II Year', sym: '○', color: 'var(--primary)' },
];
